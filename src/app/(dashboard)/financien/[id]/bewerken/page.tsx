    ...
    <div className="max-w-4xl mx-auto p-4 lg:p-8 space-y-8">
      ...
      <div className="flex items-center justify-end gap-4">
        ...
        <button
          ...
          disabled={laden}
          className="px-6 py-2.5 bg-autronis-accent hover:bg-autronis-accent-hover text-autronis-bg rounded-xl text-sm font-semibold transition-colors shadow-lg shadow-autronis-accent/20 disabled:opacity-50 btn-press"
        >
