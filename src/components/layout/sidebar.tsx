  ...
  // De 6 hubs
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Megaphone,
        children: [
          { label: "Content Engine", icon: Megaphone, href: "/content", alsoMatches: [] },
          { label: "Posts", icon: PenLine, href: "/content/posts" },
          { label: "Kalender", icon: CalendarDays, href: "/content/kalender" },
          { label: "Kennisbank", icon: Library, href: "/content/kennisbank" },
